...
def _serialize_vocab(vocab: dict[int, bytes], out_path: Path) -> None:
    # Store as a JSON lines file for easy inspection.
...
def main() -> int:
    ...
    parser.add_argument(
        "--input",
        default="/data/share/hw1-data/TinyStoriesV2-GPT4-train.txt",
        help="Path to TinyStories training text",
    )
    ...
    parser.add_argument(
        "--out-dir",
        default="artifacts/bpe/tinystories",
